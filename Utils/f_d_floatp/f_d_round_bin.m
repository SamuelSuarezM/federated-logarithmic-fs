function [p,cnext]=f_d_round_bin(bin,nbits,sig);
...
% Correction of small bugs found by Mantas Mikaitis
...
switch round_mode 
 ...
 l = f_d_bin2frac(bin(1:nbits));
 w = f_d_bin2frac(f_d_add_bin_one_carry(bin(1:nbits))) - l ;
 dist = (dec - l) / w;
 r = rand;
 if r >= dist
 %{
